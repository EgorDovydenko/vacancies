 ...
 * Источник включается/отключается через переменные окружения SOURCE_HH, SOURCE_RABOTABY, SOURCE_DEVBY, SOURCE_HABR, SOURCE_GETMATCH.
 */
export function getSources(): Source[] {
  const { hh, rabotaby, devby, habr, getmatch } = config.sources;
